      ...
      <div className="p-10">
        <div className="max-w-sm rounded overflow-hidden shadow-lg">
          ...
          <div className="px-6 pb-8 flex justify-center">
            <div className="bg-red-800 hover:bg-red-600 py-2 px-6 rounded shadow-md hover:shadow-lg uppercase text-white font-bold select-none cursor-pointer">Purchase</div>
          </div>
        </div>
      </div>
    </>
